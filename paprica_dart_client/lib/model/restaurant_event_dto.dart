...
class RestaurantEventDto {
  ...
  static List<RestaurantEventDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<RestaurantEventDto>() : json.map((value) => new RestaurantEventDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantEventDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantEventDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RestaurantEventDto.fromJson(value));
    }
    return map;
  }
}
