...
class GetRoleForEditOutput {
  ...
  GetRoleForEditOutput.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    role = new RoleEditDto.fromJson(json['role']);
    permissions = FlatPermissionDto.listFromJson(json['permissions']);
    grantedPermissionNames = (json['grantedPermissionNames'] as List)
  ...
  static List<GetRoleForEditOutput> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<GetRoleForEditOutput>()
        : json
            .map((value) => new GetRoleForEditOutput.fromJson(value))
            .toList();
  }

  static Map<String, GetRoleForEditOutput> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, GetRoleForEditOutput>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new GetRoleForEditOutput.fromJson(value));
    }
    return map;
  }
}
