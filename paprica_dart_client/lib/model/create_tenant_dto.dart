...
class CreateTenantDto {
  ...
  static List<CreateTenantDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CreateTenantDto>() : json.map((value) => new CreateTenantDto.fromJson(value)).toList();
  }

  static Map<String, CreateTenantDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CreateTenantDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CreateTenantDto.fromJson(value));
    }
    return map;
  }
}
