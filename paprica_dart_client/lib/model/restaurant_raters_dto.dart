...
class RestaurantRatersDto {
  ...
  static List<RestaurantRatersDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RestaurantRatersDto>()
        : json.map((value) => new RestaurantRatersDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantRatersDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantRatersDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RestaurantRatersDto.fromJson(value));
    }
    return map;
  }
}
