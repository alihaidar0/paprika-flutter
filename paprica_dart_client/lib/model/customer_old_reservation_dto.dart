...
class CustomerOldReservationDto {
  ...
  static List<CustomerOldReservationDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CustomerOldReservationDto>() : json.map((value) => new CustomerOldReservationDto.fromJson(value)).toList();
  }

  static Map<String, CustomerOldReservationDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CustomerOldReservationDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CustomerOldReservationDto.fromJson(value));
    }
    return map;
  }
}
