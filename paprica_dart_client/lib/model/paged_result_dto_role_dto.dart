...
class PagedResultDtoRoleDto {
  ...
  static List<PagedResultDtoRoleDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<PagedResultDtoRoleDto>()
        : json
            .map((value) => new PagedResultDtoRoleDto.fromJson(value))
            .toList();
  }

  static Map<String, PagedResultDtoRoleDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PagedResultDtoRoleDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new PagedResultDtoRoleDto.fromJson(value));
    }
    return map;
  }
}
