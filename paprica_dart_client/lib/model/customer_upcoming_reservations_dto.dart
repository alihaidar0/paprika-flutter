...
class CustomerUpcomingReservationsDto {
  ...
  CustomerUpcomingReservationsDto.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    upcoming = CustomerUpcomingReservationDto.listFromJson(json['upcoming']);
  ...
  static List<CustomerUpcomingReservationsDto> listFromJson(
      List<dynamic> json) {
    return json == null
        ? new List<CustomerUpcomingReservationsDto>()
        : json
            .map((value) => new CustomerUpcomingReservationsDto.fromJson(value))
            .toList();
  }

  static Map<String, CustomerUpcomingReservationsDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CustomerUpcomingReservationsDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new CustomerUpcomingReservationsDto.fromJson(value));
    }
    return map;
  }
}
