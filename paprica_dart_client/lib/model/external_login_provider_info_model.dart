...
class ExternalLoginProviderInfoModel {
  ...
  static List<ExternalLoginProviderInfoModel> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<ExternalLoginProviderInfoModel>()
        : json
            .map((value) => new ExternalLoginProviderInfoModel.fromJson(value))
            .toList();
  }

  static Map<String, ExternalLoginProviderInfoModel> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ExternalLoginProviderInfoModel>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new ExternalLoginProviderInfoModel.fromJson(value));
    }
    return map;
  }
}
