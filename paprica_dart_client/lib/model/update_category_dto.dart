...
class UpdateCategoryDto {
  ...
  static List<UpdateCategoryDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<UpdateCategoryDto>()
        : json.map((value) => new UpdateCategoryDto.fromJson(value)).toList();
  }

  static Map<String, UpdateCategoryDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateCategoryDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new UpdateCategoryDto.fromJson(value));
    }
    return map;
  }
}
