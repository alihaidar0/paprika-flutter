...
class CreateRestaurantDto {
  ...
  static List<CreateRestaurantDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<CreateRestaurantDto>()
        : json.map((value) => new CreateRestaurantDto.fromJson(value)).toList();
  }

  static Map<String, CreateRestaurantDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CreateRestaurantDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new CreateRestaurantDto.fromJson(value));
    }
    return map;
  }
}
