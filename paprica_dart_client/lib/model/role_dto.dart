...
class RoleDto {
  ...
  static List<RoleDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<RoleDto>() : json.map((value) => new RoleDto.fromJson(value)).toList();
  }

  static Map<String, RoleDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RoleDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RoleDto.fromJson(value));
    }
    return map;
  }
}
