...
class RestaurantUpcomingReservationDto {
  ...
  RestaurantUpcomingReservationDto.fromJson(Map<String, dynamic> json) {
    ...
    ;
    restaurantLongitude =
        json['restaurantLongitude']
    ;
    restaurantLatitude =
        json['restaurantLatitude']
    ;
    customerName =
        json['customerName']
    ;
...
;
  ...
  static List<RestaurantUpcomingReservationDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<RestaurantUpcomingReservationDto>() : json.map((value) => new RestaurantUpcomingReservationDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantUpcomingReservationDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantUpcomingReservationDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RestaurantUpcomingReservationDto.fromJson(value));
    }
    return map;
  }
}
