...
class CustomerProfileDto {
  ...
  static List<CustomerProfileDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CustomerProfileDto>() : json.map((value) => new CustomerProfileDto.fromJson(value)).toList();
  }

  static Map<String, CustomerProfileDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CustomerProfileDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CustomerProfileDto.fromJson(value));
    }
    return map;
  }
}
