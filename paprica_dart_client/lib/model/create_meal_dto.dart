...
;
  ...
  static List<CreateMealDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CreateMealDto>() : json.map((value) => new CreateMealDto.fromJson(value)).toList();
  }

  static Map<String, CreateMealDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CreateMealDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CreateMealDto.fromJson(value));
    }
    return map;
  }
}
