...
;
    customerReport =
      ...
      new CustomerReportDto.fromJson(json['customerReport'])
;
    id =
        json['id']
    ;
  ...
  static List<ReportDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<ReportDto>() : json.map((value) => new ReportDto.fromJson(value)).toList();
  }

  static Map<String, ReportDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, ReportDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new ReportDto.fromJson(value));
    }
    return map;
  }
}
