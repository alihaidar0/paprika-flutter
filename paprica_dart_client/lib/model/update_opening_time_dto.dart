...
class UpdateOpeningTimeDto {
  ...
  static List<UpdateOpeningTimeDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<UpdateOpeningTimeDto>() : json.map((value) => new UpdateOpeningTimeDto.fromJson(value)).toList();
  }

  static Map<String, UpdateOpeningTimeDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateOpeningTimeDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UpdateOpeningTimeDto.fromJson(value));
    }
    return map;
  }
}
