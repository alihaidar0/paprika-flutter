...
class CustomerDto {
  ...
  static List<CustomerDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CustomerDto>() : json.map((value) => new CustomerDto.fromJson(value)).toList();
  }

  static Map<String, CustomerDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CustomerDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CustomerDto.fromJson(value));
    }
    return map;
  }
}
