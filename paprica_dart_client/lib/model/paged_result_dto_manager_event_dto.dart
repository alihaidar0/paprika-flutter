...
class PagedResultDtoManagerEventDto {
  ...
  PagedResultDtoManagerEventDto.fromJson(Map<String, dynamic> json) {
    ...
    items = ManagerEventDto.listFromJson(json['items']);
  }
  ...
  static List<PagedResultDtoManagerEventDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<PagedResultDtoManagerEventDto>()
        : json
            .map((value) => new PagedResultDtoManagerEventDto.fromJson(value))
            .toList();
  }

  static Map<String, PagedResultDtoManagerEventDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PagedResultDtoManagerEventDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new PagedResultDtoManagerEventDto.fromJson(value));
    }
    return map;
  }
}
