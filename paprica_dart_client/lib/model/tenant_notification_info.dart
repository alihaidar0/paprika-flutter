...
class TenantNotificationInfo {
  ...
  TenantNotificationInfo.fromJson(Map<String, dynamic> json) {
    ...
    entityTypeAssemblyQualifiedName =
        json['entityTypeAssemblyQualifiedName']
    ;
    entityId =
        json['entityId']
    ;
  ...
  static List<TenantNotificationInfo> listFromJson(List<dynamic> json) {
    return json == null ? new List<TenantNotificationInfo>() : json.map((value) => new TenantNotificationInfo.fromJson(value)).toList();
  }

  static Map<String, TenantNotificationInfo> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, TenantNotificationInfo>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new TenantNotificationInfo.fromJson(value));
    }
    return map;
  }
}
