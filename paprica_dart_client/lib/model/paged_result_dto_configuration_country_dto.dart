...
class PagedResultDtoConfigurationCountryDto {
  ...
  PagedResultDtoConfigurationCountryDto.fromJson(Map<String, dynamic> json) {
    ...
    items = ConfigurationCountryDto.listFromJson(json['items']);
  }
  ...
  static List<PagedResultDtoConfigurationCountryDto> listFromJson(
      List<dynamic> json) {
    return json == null
        ? new List<PagedResultDtoConfigurationCountryDto>()
        : json
            .map((value) =>
                new PagedResultDtoConfigurationCountryDto.fromJson(value))
            .toList();
  }

  static Map<String, PagedResultDtoConfigurationCountryDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PagedResultDtoConfigurationCountryDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new PagedResultDtoConfigurationCountryDto.fromJson(value));
    }
    return map;
  }
}
