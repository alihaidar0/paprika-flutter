...
;
  ...
  static List<RestaurantOldReservationDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<RestaurantOldReservationDto>() : json.map((value) => new RestaurantOldReservationDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantOldReservationDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantOldReservationDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RestaurantOldReservationDto.fromJson(value));
    }
    return map;
  }
}
