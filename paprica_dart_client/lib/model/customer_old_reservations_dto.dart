...
;
  ...
  static List<CustomerOldReservationsDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<CustomerOldReservationsDto>() : json.map((value) => new CustomerOldReservationsDto.fromJson(value)).toList();
  }

  static Map<String, CustomerOldReservationsDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CustomerOldReservationsDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CustomerOldReservationsDto.fromJson(value));
    }
    return map;
  }
}
