...
class RestaurantOldReservationsDto {
  ...
  Map<String, dynamic> toJson() {
    return {'oldReservations': oldReservations};
  }

  static List<RestaurantOldReservationsDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RestaurantOldReservationsDto>()
        : json
            .map((value) => new RestaurantOldReservationsDto.fromJson(value))
            .toList();
  }

  static Map<String, RestaurantOldReservationsDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantOldReservationsDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RestaurantOldReservationsDto.fromJson(value));
    }
    return map;
  }
}
