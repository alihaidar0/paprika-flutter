...
class UpdateActivationStatusDto {
  ...
  static List<UpdateActivationStatusDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<UpdateActivationStatusDto>()
        : json
            .map((value) => new UpdateActivationStatusDto.fromJson(value))
            .toList();
  }

  static Map<String, UpdateActivationStatusDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateActivationStatusDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new UpdateActivationStatusDto.fromJson(value));
    }
    return map;
  }
}
