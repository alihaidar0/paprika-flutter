...
class RestaurantProfileDto {
  ...
  static List<RestaurantProfileDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<RestaurantProfileDto>() : json.map((value) => new RestaurantProfileDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantProfileDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantProfileDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RestaurantProfileDto.fromJson(value));
    }
    return map;
  }
}
