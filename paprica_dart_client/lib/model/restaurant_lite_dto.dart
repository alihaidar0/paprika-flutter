...
class RestaurantLiteDto {
  ...
  static List<RestaurantLiteDto> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RestaurantLiteDto>()
        : json.map((value) => new RestaurantLiteDto.fromJson(value)).toList();
  }

  static Map<String, RestaurantLiteDto> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RestaurantLiteDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RestaurantLiteDto.fromJson(value));
    }
    return map;
  }
}
