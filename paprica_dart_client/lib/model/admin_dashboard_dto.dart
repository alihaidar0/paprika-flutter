...
class AdminDashboardDto {
  ...
  AdminDashboardDto.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    activeReportsCount =
        json['activeReportsCount']
    ;
    restaurantsCount =
        json['restaurantsCount']
    ;
    featuredRestaurantsCount =
        json['featuredRestaurantsCount']
    ;
    customersCount =
        json['customersCount']
    ;
  ...
  static List<AdminDashboardDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<AdminDashboardDto>() : json.map((value) => new AdminDashboardDto.fromJson(value)).toList();
  }

  static Map<String, AdminDashboardDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AdminDashboardDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AdminDashboardDto.fromJson(value));
    }
    return map;
  }
}
