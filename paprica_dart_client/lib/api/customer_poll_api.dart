...
class CustomerPollApi {
  ...
  ///
  ///
  Future<MassageDto> apiServicesAppCustomerPollClearVotePost(
      {int pollId}) async {
    ...
    // create path and map variables
    String path = "/api/services/app/Customer/Poll/ClearVote"
        .replaceAll("{format}", "json");
    ...
    if (pollId != null) {
      queryParams.addAll(
          _convertParametersForCollectionFormat("", "pollId", pollId));
    }
