...
class CustomerMenuApi {
  ...
  ///
  Future<MealDto>
  apiServicesAppCustomerMenuGetMealGet({int id}) async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/api/services/app/Customer/Menu/GetMeal"
        .replaceAll("{format}", "json");
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'MealDto') as MealDto;
    } else {
      return null;
    }
  }
