...
class ManagerReviewApi {
  ...
  ManagerReviewApi([ApiClient apiClient])
      : apiClient = apiClient ?? defaultApiClient;

  ///
  ///
  ///
  Future<PagedResultDtoReviewDto> apiServicesAppManagerReviewGetAllGet(
    ...
    String path = "/api/services/app/Manager/Review/GetAll"
