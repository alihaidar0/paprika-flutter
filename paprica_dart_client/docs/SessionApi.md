...
------------- | ------------- | -------------
[**apiServicesAppSessionGetCurrentLoginInformationsGet**](SessionApi.md#apiServicesAppSessionGetCurrentLoginInformationsGet) | **GET** /api/services/app/Session/GetCurrentLoginInformations | 
