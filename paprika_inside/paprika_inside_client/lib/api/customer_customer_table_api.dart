...
class CustomerCustomerTableApi {
  final ApiClient apiClient;

  CustomerCustomerTableApi([ApiClient apiClient])
  ...
  Future<InvoicesInvoiceDto>
    ...
    if (customerTableId == null) {
      throw new ApiException(400, "Missing required param: customerTableId");
    }

    // create path and map variables
    String path =
        "/api/app/customer-customer-table/ask-for-invoice/{customerTableId}"
            .replaceAll("{format}", "json")
            .replaceAll(
                "{" + "customerTableId" + "}", customerTableId.toString());
  ...
  ///
  ///
  Future apiAppCustomerCustomerTableCloseCustomerTableCustomerTableIdPost(
      String customerTableId) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path =
        "/api/app/customer-customer-table/close-customer-table/{customerTableId}"
            .replaceAll("{format}", "json")
            .replaceAll(
                "{" + "customerTableId" + "}", customerTableId.toString());
  ...
  Future<String> apiAppCustomerCustomerTableCustomerTablePost(
    ...
    // create path and map variables
    String path = "/api/app/customer-customer-table/customer-table"
        .replaceAll("{format}", "json");
  ...
  Future apiAppCustomerCustomerTableOrderMealsPut(
    ...
    // create path and map variables
    String path = "/api/app/customer-customer-table/order-meals"
        .replaceAll("{format}", "json");
  ...
  Future apiAppCustomerCustomerTableOrderPost(
    ...
    // create path and map variables
    String path =
        "/api/app/customer-customer-table/order".replaceAll("{format}", "json");
  ...
  Future<List<CustomerTablesOrderDto>>
    ...
    // create path and map variables
    String path = "/api/app/customer-customer-table/orders/{customerTableId}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "customerTableId" + "}", customerTableId.toString());
