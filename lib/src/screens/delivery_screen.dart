...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  DeliveryListMealModel _selectedMeal;
  List<DeliveryListMealModel> _selectedMeals = [];

  CreateDeliveryMealModel _createSelectedMeal;
  List<CreateDeliveryMealModel> _createSelectedMeals = [];
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(S.of(context).deliveryFrom + " " + widget.restaurantName),
        ),
                                  ...
                                  _createSelectedMeals.length > 0
                                      ? showDialog(
                                          ...
                                          builder: (BuildContext context) =>
                                              widget.oldDelivery != null
                                                  ? DeliveryDialog(
                                                      restaurantId:
                                                          widget.restaurantId,
                                                      restaurantName:
                                                          widget.restaurantName,
                                                      restaurantLatitude: widget
                                                          .restaurantLatitude,
                                                      restaurantLongitude: widget
                                                          .restaurantLongitude,
                                                      meals:
  ...
  Widget _alertDialog(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        S.of(context).thereAreNoMealsInDeliveryList,
      ),
      actions: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                _onOrderDeliveryPressed(context, meal);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Theme.of(context).primaryColor,
  ...
  Widget _mealCardInDragg(BuildContext context, DeliveryListMealModel meal) {
    bool isLtr = Localizations.localeOf(context).languageCode == 'en';
    Radius radiusTopRight = isLtr ? Radius.circular(15) : Radius.zero;
    Radius radiusBottomRight = isLtr ? Radius.circular(15) : Radius.zero;
    Radius radiusTopLeft = isLtr ? Radius.zero : Radius.circular(15);
  ...
  void _viewMyDeliveries(BuildContext context) {
    Navigator.of(context).pop();
